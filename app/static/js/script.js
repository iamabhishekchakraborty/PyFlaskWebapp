...
$(document).ready(function () {
	...
	//initiate the modal for displaying the charts, if you don't have charts, then you comment the below line
	$('.modal').modal();
...
function setUserResponse(message) {
	var UserResponse = '<img class="userAvatar" src=' + "./static/images/userAvatar.jpg" + '><p class="userMsg">' + message + ' </p><div class="clearfix"></div>';
...
function setBotResponse(response) {
	...
	setTimeout(function () {
		...
		if (response.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="./static/images/botAvatar.png"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
			...
			for (i = 0; i < response.length; i++) {
				...
				if (response[i].hasOwnProperty("text")) {
					var BotResponse = '<img class="botAvatar" src="./static/images/botAvatar.png"/><p class="botMsg">' + response[i].text + '</p><div class="clearfix"></div>';
					$(BotResponse).appendTo(".chats").hide().fadeIn(1000);
				}
